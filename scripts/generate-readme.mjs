...
const categoryResourcePaths = {
  ...
  document: 'prompts/documents/README.md',
...
const categoryTable = catalog.categories
  .map((category) => {
    ...
    return `| ${presentation.emoji} [${category.label}](#${category.slug}) | ${category.caseCount} | [Open category README](${categoryResourcePaths[category.slug]}) | [Browse on PagePop](${websiteCategoryUrl}) |`
  })
  .join('\n')
