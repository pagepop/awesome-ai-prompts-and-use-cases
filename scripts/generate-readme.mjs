...
const categoryTable = publishedCategories
  .map((category) => {
    ...
    return `| ${presentation.emoji} [${category.label}](#${category.slug}) | [Open category README](${categoryResourcePaths[category.slug]}) | [Browse on PagePop](${websiteCategoryUrl}) |`
  })
  .join('\n')
...
console.log(`Generated ${readmePath} with published prompts.`)
