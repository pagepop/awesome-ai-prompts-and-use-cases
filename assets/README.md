...
- `pagepop-visual-gallery.png`: the PagePop visual gallery screenshot shown above the website link in the root README.
- `pagepop-visual-gallery-zh.png`: the localized visual gallery screenshot shown in the Simplified Chinese root README.
